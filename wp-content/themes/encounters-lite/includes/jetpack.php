 ...
 */
function encounters_lite_infinite_scroll_init() {
	add_theme_support( 'infinite-scroll', array(
    'container'  => 'content',
    'footer'     => 'page',
	) );
}
add_action( 'after_setup_theme', 'encounters_lite_infinite_scroll_init' );
...
add_filter( 'infinite_scroll_has_footer_widgets', 'encounters_lite_has_footer_widgets' );